    ...
    <div className="space-y-2">
      ...
      <div className="flex flex-wrap gap-1.5 md:flex-nowrap">
        <button
          ...
          className={clsx(
            'flex w-full items-center justify-between rounded-lg border border-gray-300 px-4 py-2 text-sm hover:!border-green-500 focus:outline-none dark:border-gray-700',
            {
              '!border-green-500':
        ...
        <button
          ...
          className={clsx(
            'flex w-full items-center justify-between rounded-lg border border-gray-300 px-4 py-1 text-sm hover:!border-green-500 focus:outline-none dark:border-gray-700',
            {
              '!border-green-500':
                uploadedVideo.collectModule.followerOnlyCollect &&
                !uploadedVideo.collectModule.isRevertCollect
