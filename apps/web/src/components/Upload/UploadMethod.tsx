...
const UploadMethod = () => {
  ...
  return (
    ...
    >
      <Tab.List className="flex space-x-1 rounded-sm bg-gray-200 p-1 dark:bg-gray-800">
        <Tab
          className={({ selected }) =>
            clsx(
              'w-full rounded-sm py-2.5 text-sm font-medium leading-5 focus:outline-none',
        ...
        <Tab
          className={({ selected }) =>
            clsx(
              'w-full rounded-sm text-sm font-medium leading-5 focus:outline-none disabled:opacity-30',
              selected
