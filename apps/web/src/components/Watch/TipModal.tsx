      ...
      <form className="mt-2" onSubmit={handleSubmit(onSendTip)}>
        ...
        <div className="mt-4">
          <TextArea
            ...
            autoComplete="off"
            className="w-full rounded-sm border border-gray-200 bg-white p-2 text-sm outline-none focus:ring-1 focus:ring-green-500 disabled:bg-gray-500 disabled:bg-opacity-20 disabled:opacity-60 dark:border-gray-800 dark:bg-gray-900"
            rows={3}
          />
