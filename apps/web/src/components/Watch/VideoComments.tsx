...
const VideoComments: FC<Props> = ({ video, hideTitle = false }) => {
  ...
  return (
    <>
      <div className="flex-shrink-0 border-b-[1px] dark:border-slate-600 ">
