...
const SensitiveWarning: FC<Props> = ({ acceptWarning }) => {
  return (
    <div className="flex h-56 w-full items-center justify-center space-x-5 rounded-sm bg-black px-10 text-lg text-white md:h-[60vh]">
      <div className="flex flex-col">
        ...
        <div>
          <button
            type="button"
            className="mt-5 rounded-sm bg-gray-800 px-5 py-2 text-sm outline-none"
